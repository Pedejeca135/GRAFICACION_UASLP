...
Face ::Face(vector <Edge> fars,int NF)
{
			AristasVerticesDirect = fars;
			NumFace = NF;
}
...
void Face :: AddAristasVerticesDirect(Vertex initial, Vertex final)
{
    Edge e = Edge(initial,final);
    AristasVerticesDirect.push_back(e); 
}
